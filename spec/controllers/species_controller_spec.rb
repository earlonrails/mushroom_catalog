  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved species as @species" do
        ...
        allow_any_instance_of(Species).to receive(:save).and_return(false)
        post :create, {:species => { "name" => "invalid value" }}, valid_session
        expect(assigns(:species)).to be_a_new(Species)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested species" do
        ...
        expect_any_instance_of(Species).to receive(:update).with({ "name" => "MyString" })
        put :update, {:id => species.to_param, :species => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the species as @species" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        allow_any_instance_of(Species).to receive(:save).and_return(false)
        put :update, {:id => species.to_param, :species => { "name" => "invalid value" }}, valid_session
        expect(assigns(:species)).to eq(species)
      end
